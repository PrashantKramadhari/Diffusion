...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def from_unet(
        ...
        # Copy conv_in weights and bias
        controlnet.conv_in.load_state_dict(unet.conv_in.state_dict())

        # Copy time_proj and time_embedding
        controlnet.time_proj.load_state_dict(unet.time_proj.state_dict())
        controlnet.time_embedding.load_state_dict(unet.time_embedding.state_dict())

        # Copy down_blocks
        for c_block, u_block in zip(controlnet.down_blocks, unet.down_blocks):
            c_block.load_state_dict(u_block.state_dict())
    ...
    def forward(
        ...
        controlnet_down_blocks = self.controlnet_down_blocks
        processed_down_block_res_samples = []
        for i, res_sample in enumerate(down_block_res_samples):
            processed = controlnet_down_blocks[i](res_sample)
            processed_down_block_res_samples.append(processed)
        down_block_res_samples = tuple(processed_down_block_res_samples)
